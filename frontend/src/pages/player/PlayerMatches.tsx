...
export default function PlayerMatches() {
  ...
  const [matches] = useState<Match[]>([
    { id: '1', tournament: 'National Championship 2024', opponent: 'John Smith', category: 'Kumite -65kg', date: '2024-12-15', time: '10:00 AM', venue: 'Sports Complex A', status: 'Upcoming', result: 'Pending', round: 'Quarter Final' },
    { id: '2', tournament: 'Regional Open 2024', opponent: 'Mike Johnson', category: 'Kata', date: '2024-11-25', time: '02:30 PM', venue: 'Dojo Hall B', status: 'Completed', result: 'Win', score: '5-3', round: 'Semi Final' },
    { id: '3', tournament: 'Youth Tournament', opponent: 'Tom Brown', category: 'Kumite -55kg', date: '2024-10-15', time: '11:00 AM', venue: 'Central Gym', status: 'Completed', result: 'Loss', score: '2-4', round: 'Final' },
    { id: '4', tournament: 'Inter-School Competition', opponent: 'Chris Lee', category: 'Team Kata', date: '2024-12-05', time: '03:00 PM', venue: 'Training Center', status: 'Upcoming', result: 'Pending', round: 'Preliminary' },
    { id: '5', tournament: 'Black Belt Championship', opponent: 'Alex Wilson', category: 'Kumite -75kg', date: '2025-01-20', time: '01:30 PM', venue: 'Main Arena', status: 'Upcoming', result: 'Pending', round: 'Quarter Final' },
    { id: '6', tournament: 'City Open 2024', opponent: 'David Kim', category: 'Kata', date: '2024-09-10', time: '09:30 AM', venue: 'Community Center', status: 'Completed', result: 'Win', score: '5-2', round: 'Final' },
  ]);
        ...
        <div className="space-y-4">
          {filteredMatches.map((match) => (
            <div key={match.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
              <div className={`h-2 ${
                match.status === 'Upcoming' ? 'bg-gradient-to-r from-cyan-500 to-blue-500' : 'bg-gradient-to-r from-indigo-500 to-purple-500'
              }`}></div>
              <div className="p-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                        match.status === 'Upcoming' ? 'bg-cyan-100 text-cyan-700' : 'bg-indigo-100 text-indigo-700'
                      }`}>
                        {match.status}
                      </span>
