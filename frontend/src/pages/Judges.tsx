            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center space-x-2">
                  <button className="flex-1 p-2 text-blue-600 hover:bg-blue-100 rounded-lg transition duration-200" title="View Profile">
                  ...
                  <button className="flex-1 p-2 text-orange-600 hover:bg-orange-100 rounded-lg transition duration-200" title="Assign Match">
                    <svg className="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
                  </button>
